...
-   **`VITE_MARKETAUX_API_KEY`** (Optional): For the news widget functionality.
    1.  Navigate to the `frontend/` directory.
    2.  Create a file named `.env` by copying the `frontend/.env.example` file.
    3.  Get your API key from [MarketAux](https://www.marketaux.com/)
    4.  Open the `.env` file and add your MarketAux API key: `VITE_MARKETAUX_API_KEY="YOUR_ACTUAL_API_KEY"`
